...
#[derive(PartialEq,Clone,Default)]
pub struct SignDocJSON {
    // message fields
    pub body: ::protobuf::SingularPtrField<TxBody>,
    pub auth_info: ::protobuf::SingularPtrField<AuthInfo>,
    pub chain_id: ::std::string::String,
    pub account_number: u64,
    pub sign_doc_sha256_hash: ::std::vec::Vec<u8>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}

impl<'a> ::std::default::Default for &'a SignDocJSON {
    fn default() -> &'a SignDocJSON {
        <SignDocJSON as ::protobuf::Message>::default_instance()
    }
}

impl SignDocJSON {
    pub fn new() -> SignDocJSON {
        ::std::default::Default::default()
    }
    ...
    pub fn get_sign_doc_sha256_hash(&self) -> &[u8] {
        &self.sign_doc_sha256_hash
    }
    pub fn clear_sign_doc_sha256_hash(&mut self) {
        self.sign_doc_sha256_hash.clear();
    }

    // Param is passed by value, moved
    pub fn set_sign_doc_sha256_hash(&mut self, v: ::std::vec::Vec<u8>) {
        self.sign_doc_sha256_hash = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sign_doc_sha256_hash(&mut self) -> &mut ::std::vec::Vec<u8> {
        &mut self.sign_doc_sha256_hash
    }

    // Take field
    pub fn take_sign_doc_sha256_hash(&mut self) -> ::std::vec::Vec<u8> {
        ::std::mem::replace(&mut self.sign_doc_sha256_hash, ::std::vec::Vec::new())
    }
}

impl ::protobuf::Message for SignDocJSON {
    fn is_initialized(&self) -> bool {
        for v in &self.body {
            if !v.is_initialized() {
                return false;
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_singular_proto3_bytes_into(wire_type, is, &mut self.sign_doc_sha256_hash)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.sign_doc_sha256_hash.is_empty() {
            my_size += ::protobuf::rt::bytes_size(5, &self.sign_doc_sha256_hash);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.sign_doc_sha256_hash.is_empty() {
            os.write_bytes(5, &self.sign_doc_sha256_hash)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<TxBody>>(
                "body",
                |m: &SignDocJSON| { &m.body },
                |m: &mut SignDocJSON| { &mut m.body },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<AuthInfo>>(
                "auth_info",
                |m: &SignDocJSON| { &m.auth_info },
                |m: &mut SignDocJSON| { &mut m.auth_info },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "chain_id",
                |m: &SignDocJSON| { &m.chain_id },
                |m: &mut SignDocJSON| { &mut m.chain_id },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                "account_number",
                |m: &SignDocJSON| { &m.account_number },
                |m: &mut SignDocJSON| { &mut m.account_number },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                "sign_doc_sha256_hash",
                |m: &SignDocJSON| { &m.sign_doc_sha256_hash },
                |m: &mut SignDocJSON| { &mut m.sign_doc_sha256_hash },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<SignDocJSON>(
                "SignDocJSON",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static SignDocJSON {
        static instance: ::protobuf::rt::LazyV2<SignDocJSON> = ::protobuf::rt::LazyV2::INIT;
        instance.get(SignDocJSON::new)
    }
}

impl ::protobuf::Clear for SignDocJSON {
    fn clear(&mut self) {
        self.body.clear();
        self.auth_info.clear();
        self.chain_id.clear();
...
impl ::std::fmt::Debug for SignDocJSON {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for SignDocJSON {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    o\x1a\x19google/protobuf/any.proto\x1a\x19cosmos_proto/cosmos.proto\"\
    \x8d\x01\n\x02Tx\x12-\n\x04body\x18\x01\x20\x01(\x0b2\x19.cosmos.tx.v1be\
    ta1.TxBodyR\x04body\x128\n\tauth_info\x18\x02\x20\x01(\x0b2\x1b.cosmos.t\
    x.v1beta1.AuthInfoR\x08authInfo\x12\x1e\n\nsignatures\x18\x03\x20\x03(\
    \x0cR\nsignatures\"n\n\x05TxRaw\x12\x1d\n\nbody_bytes\x18\x01\x20\x01(\
    \x0cR\tbodyBytes\x12&\n\x0fauth_info_bytes\x18\x02\x20\x01(\x0cR\rauthIn\
    foBytes\x12\x1e\n\nsignatures\x18\x03\x20\x03(\x0cR\nsignatures\"\x92\
    \x01\n\x07SignDoc\x12\x1d\n\nbody_bytes\x18\x01\x20\x01(\x0cR\tbodyBytes\
    \x12&\n\x0fauth_info_bytes\x18\x02\x20\x01(\x0cR\rauthInfoBytes\x12\x19\
    \n\x08chain_id\x18\x03\x20\x01(\tR\x07chainId\x12%\n\x0eaccount_number\
    \x18\x04\x20\x01(\x04R\raccountNumber\"\xe9\x01\n\x0bSignDocJSON\x12-\n\
    \x04body\x18\x01\x20\x01(\x0b2\x19.cosmos.tx.v1beta1.TxBodyR\x04body\x12\
    8\n\tauth_info\x18\x02\x20\x01(\x0b2\x1b.cosmos.tx.v1beta1.AuthInfoR\x08\
    authInfo\x12\x19\n\x08chain_id\x18\x03\x20\x01(\tR\x07chainId\x12%\n\x0e\
    account_number\x18\x04\x20\x01(\x04R\raccountNumber\x12/\n\x14sign_doc_s\
    ha256_hash\x18\x05\x20\x01(\x0cR\x11signDocSha256Hash\"\xee\x01\n\x10Sig\
    nDocDirectAux\x12\x1d\n\nbody_bytes\x18\x01\x20\x01(\x0cR\tbodyBytes\x12\
    3\n\npublic_key\x18\x02\x20\x01(\x0b2\x14.google.protobuf.AnyR\tpublicKe\
    y\x12\x19\n\x08chain_id\x18\x03\x20\x01(\tR\x07chainId\x12%\n\x0eaccount\
    _number\x18\x04\x20\x01(\x04R\raccountNumber\x12\x1a\n\x08sequence\x18\
    \x05\x20\x01(\x04R\x08sequence\x12(\n\x03tip\x18\x06\x20\x01(\x0b2\x16.c\
    osmos.tx.v1beta1.TipR\x03tip\"\x95\x02\n\x06TxBody\x120\n\x08messages\
    \x18\x01\x20\x03(\x0b2\x14.google.protobuf.AnyR\x08messages\x12\x12\n\
    \x04memo\x18\x02\x20\x01(\tR\x04memo\x12%\n\x0etimeout_height\x18\x03\
    \x20\x01(\x04R\rtimeoutHeight\x12B\n\x11extension_options\x18\xff\x07\
    \x20\x03(\x0b2\x14.google.protobuf.AnyR\x10extensionOptions\x12Z\n\x1eno\
    n_critical_extension_options\x18\xff\x0f\x20\x03(\x0b2\x14.google.protob\
    uf.AnyR\x1bnonCriticalExtensionOptions\"\xa0\x01\n\x08AuthInfo\x12@\n\
    \x0csigner_infos\x18\x01\x20\x03(\x0b2\x1d.cosmos.tx.v1beta1.SignerInfoR\
    \x0bsignerInfos\x12(\n\x03fee\x18\x02\x20\x01(\x0b2\x16.cosmos.tx.v1beta\
    1.FeeR\x03fee\x12(\n\x03tip\x18\x03\x20\x01(\x0b2\x16.cosmos.tx.v1beta1.\
    TipR\x03tip\"\x97\x01\n\nSignerInfo\x123\n\npublic_key\x18\x01\x20\x01(\
    \x0b2\x14.google.protobuf.AnyR\tpublicKey\x128\n\tmode_info\x18\x02\x20\
    \x01(\x0b2\x1b.cosmos.tx.v1beta1.ModeInfoR\x08modeInfo\x12\x1a\n\x08sequ\
    ence\x18\x03\x20\x01(\x04R\x08sequence\"\xe0\x02\n\x08ModeInfo\x12<\n\
    \x06single\x18\x01\x20\x01(\x0b2\".cosmos.tx.v1beta1.ModeInfo.SingleH\0R\
    \x06single\x129\n\x05multi\x18\x02\x20\x01(\x0b2!.cosmos.tx.v1beta1.Mode\
    Info.MultiH\0R\x05multi\x1aA\n\x06Single\x127\n\x04mode\x18\x01\x20\x01(\
    \x0e2#.cosmos.tx.signing.v1beta1.SignModeR\x04mode\x1a\x90\x01\n\x05Mult\
    i\x12K\n\x08bitarray\x18\x01\x20\x01(\x0b2/.cosmos.crypto.multisig.v1bet\
    a1.CompactBitArrayR\x08bitarray\x12:\n\nmode_infos\x18\x02\x20\x03(\x0b2\
    \x1b.cosmos.tx.v1beta1.ModeInfoR\tmodeInfosB\x05\n\x03sum\"\xeb\x01\n\
    \x03Fee\x12c\n\x06amount\x18\x01\x20\x03(\x0b2\x19.cosmos.base.v1beta1.C\
    oinR\x06amountB0\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins\
    \xc8\xde\x1f\0\x12\x1b\n\tgas_limit\x18\x02\x20\x01(\x04R\x08gasLimit\
    \x12.\n\x05payer\x18\x03\x20\x01(\tR\x05payerB\x18\xd2\xb4-\x14cosmos.Ad\
    dressString\x122\n\x07granter\x18\x04\x20\x01(\tR\x07granterB\x18\xd2\
    \xb4-\x14cosmos.AddressString\"j\n\x03Tip\x121\n\x06amount\x18\x01\x20\
    \x03(\x0b2\x19.cosmos.base.v1beta1.CoinR\x06amount\x120\n\x06tipper\x18\
    \x02\x20\x01(\tR\x06tipperB\x18\xd2\xb4-\x14cosmos.AddressStringB'Z%gith\
    ub.com/cosmos/cosmos-sdk/types/txb\x06proto3\
";

...
impl ::protobuf::ProtobufEnum for SignMode {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<SignMode> {
        match value {
            ...
            3 => ::std::option::Option::Some(SignMode::SIGN_MODE_DIRECT_JSON),
            4 => ::std::option::Option::Some(SignMode::SIGN_MODE_DIRECT_AUX),
    ...
    fn values() -> &'static [Self] {
        static values: &'static [SignMode] = &[
            ...
            SignMode::SIGN_MODE_DIRECT_JSON,
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    IRECT\x10\x01\x12\x15\n\x11SIGN_MODE_TEXTUAL\x10\x02\x12\x19\n\x15SIGN_M\
    ODE_DIRECT_JSON\x10\x03\x12\x18\n\x14SIGN_MODE_DIRECT_AUX\x10\x04\x12\
    \x1f\n\x1bSIGN_MODE_LEGACY_AMINO_JSON\x10\x7fB/Z-github.com/cosmos/cosmo\
    s-sdk/types/tx/signingb\x06proto3\
";

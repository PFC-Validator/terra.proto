...
use crate::tendermint::version::types::Consensus;
...
pub struct Header {
    // message fields
    pub version: ::protobuf::SingularPtrField<super::types::Consensus>,
...
impl Header {
    ...
    pub fn get_version(&self) -> &super::types::Consensus {
        self.version.as_ref().unwrap_or_else(|| <super::types::Consensus as ::protobuf::Message>::default_instance())
    }
    ...
    // Param is passed by value, moved
    pub fn set_version(&mut self, v: super::types::Consensus) {
        self.version = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_version(&mut self) -> &mut super::types::Consensus {
    ...
    // Take field
    pub fn take_version(&mut self) -> super::types::Consensus {
        self.version.take().unwrap_or_else(|| super::types::Consensus::new())
    }
...
impl ::protobuf::Message for Header {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            let mut fields = ::std::vec::Vec::new();
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::types::Consensus>>(
                "version",
                |m: &Header| { &m.version },
